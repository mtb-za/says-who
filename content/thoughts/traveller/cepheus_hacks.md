...
| Name | Publisher | Year Published | Comments |
|---|---|---|---|
| [Cepheus Engine SRD](https://www.drivethrurpg.com/en/product/237247/cepheus-engine-rpg) | Moon Toad | 2018 | This is a more nicely laid version of the rules in the SRD, with art and such things. A complete ruleset that is well-suited for being a replacement for Traveller-the-Rules. It does not detail a setting and there are no aliens. A good baseline, with minimal changes to Mongoose 1e basic rules. |
...
| [Kosmic RPG](https://www.drivethrurpg.com/en/product/458032/)kosmic-role-playing-game-core-rules | Wild Bee | 2023 | Biggest change is the massive number of careers. Otherwise fairly close to CE SRD, with some organisational differences in information presentation and small changes in other things. Used as the basis for _Solis: People of the Sun_. |
...
| [Modern War](https://www.drivethrurpg.com/en/product/304503/modern-war) | Zozer Games | 2020 | A modern (1990s to 2020s) military-focused game. Has a number of rules overlapping with Cepheus Universal and Hostile, in particular how firefights with less visible opponents go. Changes to careers to suit modern-day Earth military are pretty solid, along with a handful of ideas for specific units in some modern militaries. Extensive vehicle and equipment list that could well be stolen (and possibly reskinned to have lasers or similar) for more futuristic games. Supplements for WW2 and Vietnam as well as air combat and more detailed versions of the potential wars in the core book have been released. |
...
_Clement Sector_ is probably the most fleshed out setting on this list, with a large number of ships, colonies, different types of campaign and so on detailed in various supplements.
_Hostile_ also has a fairly extensive catalogue of additional material (and much of the mechanical parts of that catalogue have been incorporated into _Cepheus Universal_).
_Faster Than Light: Nomad_ is not CE based, but if you were to use it without telling people it would probably not raise any eyebrows. It has had a few specific supplements that are worth looking at (in particular, _Retro Rockets_ is a fun 1950s pulp setting).
_Cepheus Deluxe_ supplements mostly expand on the _Terra Arisen_ setting.
